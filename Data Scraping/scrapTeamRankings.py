...
def scrap(url):
  data = get_first_table(url)
  col_name = list_of_headers(data)
  final = create_df(soup_table=data,list_of_column_names=col_name)

  final.to_csv('/mnt/c/users/tony/git/Gambling_Software/teamrankings.csv')
  print(final)


scrap("https://www.teamrankings.com/nba/team/atlanta-hawks/ats-trends")
